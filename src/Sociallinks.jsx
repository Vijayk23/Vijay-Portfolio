  ...
  return (
    <div id="socialmedia-link">
      <Link to="https://www.linkedin.com/in/vijayk23/" target="_blank">
        <img id="img" src="./images/linkedin-logo.png" alt="linkedin" />
      </Link>
      <Link to="https://github.com/Vijayk23" target="_blank">
        <img id="img" src="./images/github-logo.png" alt="github" />
      </Link>
      <Link
        to="https://www.facebook.com/profile.php?id=100047753657999"
        target="_blank"
      >
        <img id="img" src="./images/facebook-logo.png" alt="facebook" />
      </Link>
